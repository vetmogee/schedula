  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-24">
      ...
      <div className="text-center mb-10 sm:mb-12 md:mb-16">
        <div className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-white/80 dark:bg-card/80 backdrop-blur mb-4 sm:mb-6">
          <Calendar className="w-12 h-12 sm:w-14 sm:h-14 text-[#ff4a7a] sm:text-[#ff6b9d]" />
        </div>
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-gray-900 dark:text-foreground mb-3 sm:mb-4 leading-tight">
          Welcome to Schedula
        </h1>
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 dark:text-muted-foreground max-w-2xl mx-auto leading-relaxed px-2">
      ...
      <section className="mb-10 sm:mb-12 md:mb-16">
        <div className="rounded-2xl bg-white/80 dark:bg-card/80 backdrop-blur shadow-lg p-5 sm:p-6 md:p-8 lg:p-12 border border-white/60 dark:border-border">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-foreground mb-4 sm:mb-6 leading-tight">
            What is Schedula?
          </h2>
          <p className="text-base sm:text-lg text-gray-700 dark:text-muted-foreground leading-relaxed mb-3 sm:mb-4">
      ...
      {/* Features Grid */}
      <section className="mb-10 sm:mb-12 md:mb-16">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-foreground mb-6 sm:mb-8 text-center leading-tight">
          Features
        </h2>
        <div className="grid md:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
          {/* Customer Features */}
          <div className="rounded-2xl bg-white/80 dark:bg-card/80 backdrop-blur shadow-lg p-5 sm:p-6 md:p-8 border border-white/60 dark:border-border">
            <div className="flex items-center gap-2 sm:gap-3 mb-4">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-foreground leading-tight">For Customers</h3>
            </div>
            <ul className="space-y-2.5 sm:space-y-3 text-gray-700 dark:text-muted-foreground">
          ...
          <div className="rounded-2xl bg-white/80 dark:bg-card/80 backdrop-blur shadow-lg p-5 sm:p-6 md:p-8 border border-white/60 dark:border-border">
            <div className="flex items-center gap-2 sm:gap-3 mb-4">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-foreground leading-tight">For Salons</h3>
            </div>
            <ul className="space-y-2.5 sm:space-y-3 text-gray-700 dark:text-muted-foreground">
              <li className="flex items-start gap-2 sm:gap-3">
                <CheckCircle className="w-5 h-5 text-[#ff6b9d] mt-0.5 flex-shrink-0" />
      ...
      <section className="mb-10 sm:mb-12 md:mb-16">
        <div className="rounded-2xl bg-white/80 dark:bg-card/80 backdrop-blur shadow-lg p-5 sm:p-6 md:p-8 lg:p-12 border border-white/60 dark:border-border">
          <div className="flex items-center gap-2 sm:gap-3 mb-5 sm:mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-foreground leading-tight">
              Why Choose Schedula?
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-5 sm:gap-6">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-foreground mb-2 leading-tight">Save Time</h3>
              <p className="text-sm sm:text-base text-gray-700 dark:text-muted-foreground leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-foreground mb-2 leading-tight">Easy to Use</h3>
              <p className="text-sm sm:text-base text-gray-700 dark:text-muted-foreground leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-foreground mb-2 leading-tight">Stay Organized</h3>
              <p className="text-sm sm:text-base text-gray-700 dark:text-muted-foreground leading-relaxed">
      ...
      <section className="text-center">
        <div className="rounded-2xl bg-white/80 dark:bg-card/80 backdrop-blur shadow-lg p-5 sm:p-6 md:p-8 lg:p-12 border border-white/60 dark:border-border">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-foreground mb-3 sm:mb-4 leading-tight">
            Ready to Get Started?
          </h2>
          <p className="text-base sm:text-lg text-gray-700 dark:text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            ...
            <Link
              href="/salon-register"
              className="inline-flex items-center justify-center px-6 sm:px-8 py-3.5 sm:py-3 bg-white dark:bg-card text-[#ff6b9d] text-sm sm:text-base font-semibold rounded-lg border-2 border-[#ff6b9d] hover:bg-[#ff6b9d] hover:text-white active:bg-[#ff5a8a] transition-colors shadow-md min-h-[44px] touch-manipulation"
            >
              Register Your Salon
            </Link>
          </div>
          <p className="mt-5 sm:mt-6 text-sm sm:text-base text-gray-600 dark:text-muted-foreground">
